...
namespace cxy
{
            ...
            const SamplingParams &params)
    {
        ...
        sensor_msgs::convertPointCloudToPointCloud2(cloud, cloud_tmp);
    ...
    bool cxy_CAD_helper::stlToShape(const std::string &filename, shapes::Mesh &shape)
    {
        ...
        {
            ROS_ERROR_STREAM("cxy_CAD_helper::stlToShape - Could not load resource file.");
            return false;
        }
    ...
    geometry_msgs::Point32 cxy_CAD_helper::sampleRandomPoint(geometry_msgs::Point v1,
            geometry_msgs::Point v2,
            geometry_msgs::Point v3)
    {
    ...
    void cxy_CAD_helper::sampleGridPoints(geometry_msgs::Point v1, geometry_msgs::Point v2,
            geometry_msgs::Point v3,
            std::list<geometry_msgs::Point32> &samples,
            float step_size)
    {
