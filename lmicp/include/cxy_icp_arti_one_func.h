...
namespace cxy
{
    namespace cxy_lmicp_lib
    {
        ...
        class cxy_icp_arti_one_func : public cxy_optimization::Cxy_Cost_Func_Abstract< _Scalar, NX, NY>
        {
            ...
            public:
                ...
                cxy_icp_arti_one_func(pcl::PointCloud<pcl::PointXYZ>::Ptr modelCloud
